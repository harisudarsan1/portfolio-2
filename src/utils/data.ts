...
Hi there! I'm Harisudarsan, and I embarked on my programming journey by delving into full-stack web development. As I became more engrossed in coding, my enthusiasm grew for CNCF and the open-source community. 
I began making contributions to open-source projects and crafting CLI applications, all while gaining knowledge 
  in Kubernetes and essential operating system concepts.
...
export const otherProjectsData: Otherprojects[] = [
  ...
  },
  {
    ...
    details:
      "This is a group project which uses gcp api in FHIR standards to store health related data",
    github: "/",
    cta: "/",
...
export const projects: Project[] = [
  {
    title: "cslang",
    details: `A programming language written in golang from scratch`,
    technologies: ["golang"],
    image: `cslang.png`,
  ...
  {
    title: "Genesiz",
    details: ` A Production level website for a private company. 
  ...
  {
    title: "Trello clone",
    details: ` Implementation of Trello with drag and drop feature`,
